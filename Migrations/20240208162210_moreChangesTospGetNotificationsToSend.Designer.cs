...
namespace ClientPortal.Migrations
{
    ...
    [Migration("20240208162210_moreChangesTospGetNotificationsToSend")]
    partial class moreChangesTospGetNotificationsToSend
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClientPortal.Data.Entities.PortalEntities.AMRMeterAlarm", b =>
                {
                    ...
                    b.Property<DateTime?>("LastDataDTM")
            ...
            modelBuilder.Entity("ClientPortal.Data.Entities.PortalEntities.ArchivedReport", b =>
                {
                    b.Property<int>("ArchivedReportId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ArchivedReportId"), 1L, 1);
            ...
            modelBuilder.Entity("ClientPortal.Data.Entities.PortalEntities.ArchiveRequestDetail", b =>
                {
                    b.Property<int>("ArchiveRequestDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ArchiveRequestDetailId"), 1L, 1);

                    b.Property<bool>("Active")
                        .HasColumnType("bit");

                    b.Property<int>("ArchiveRequestId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ArchiveRequestDetailId");

                    b.HasIndex("ArchiveRequestId");

                    b.ToTable("ArchiveRequestDetails");
                });

            modelBuilder.Entity("ClientPortal.Data.Entities.PortalEntities.ArchiveRequestHeader", b =>
                {
                    b.Property<int>("ArchiveRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ArchiveRequestId"), 1L, 1);
                    ...
                    b.HasKey("ArchiveRequestId");

                    b.ToTable("ArchiveRequestHeaders");
                });
            ...
            modelBuilder.Entity("ClientPortal.Data.Entities.PortalEntities.ClientFeedbackReportRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ClientFeedbackReportRequests");
                });
            ...
            modelBuilder.Entity("ClientPortal.Data.Entities.PortalEntities.DemandProfileHeader", b =>
                {
                    ...
                    b.Property<double>("OffPeakDemand")
                        .HasColumnType("float");

                    b.Property<double>("OffPeakUsage")
                        .HasColumnType("float");

                    b.Property<double>("PeakDemand")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("StandardDemand")
                        .HasColumnType("float");

                    b.Property<double>("StandardUsage")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("ClientPortal.Data.Entities.PortalEntities.FeedbackReportRequest", b =>
                {
                    b.Property<int>("FeedbackReportRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FeedbackReportRequestId"), 1L, 1);
                    ...
                    b.HasKey("FeedbackReportRequestId");

                    b.ToTable("FeedbackReportRequests");
                });
            ...
            modelBuilder.Entity("ClientPortal.Data.Entities.PortalEntities.TriggeredAlarmNotification", b =>
                {
                    b.Property<int>("TriggeredAlarmNotificationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TriggeredAlarmNotificationId"), 1L, 1);
                    ...
                    b.Property<DateTime>("LastUdateDateTime")
                        .HasColumnType("datetime2");
                    ...
                    b.HasKey("TriggeredAlarmNotificationId");

                    b.ToTable("TriggeredAlarmNotifications");
                });
            ...
            modelBuilder.Entity("ClientPortal.Data.Entities.PortalEntities.ArchiveRequestDetail", b =>
                {
                    b.HasOne("ClientPortal.Data.Entities.PortalEntities.ArchiveRequestHeader", "ArchiveRequestHeader")
                        .WithMany("ArchiveRequestDetails")
                        .HasForeignKey("ArchiveRequestId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ArchiveRequestHeader");
                });
            ...
            modelBuilder.Entity("ClientPortal.Data.Entities.PortalEntities.ArchiveRequestHeader", b =>
                {
                    b.Navigation("ArchiveRequestDetails");
                });
